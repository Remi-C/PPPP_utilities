...
This function gather stats about a column by looking into pg_stats
...
BEGIN
	...
	column_stats_with_serie AS (
		...
		SELECT DISTINCT ON (frequency) rank() OVER(order by frequency DESC NULLS LAST) AS a_serie, most_commons_vals, frequency
