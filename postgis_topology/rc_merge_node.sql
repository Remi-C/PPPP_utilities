...
$BODY$
		...
		BEGIN 
			...
			IF perform_edge_geom_change = TRUE THEN 
				PERFORM rc_lib.rc_MoveNonIsoNode_edges(atopology, to_node_id, to_node_geom,_edges_to_transfer, _topology_precision) ;  
			END IF ;
			END IF ; 
			...
			PERFORM rc_lib.rc_UpdateNodeisolation( atopology, to_node_id ,to_node_geom, _edges_to_transfer); 
